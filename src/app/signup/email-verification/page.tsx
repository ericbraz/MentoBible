   ...
   return (
      <FormPagesLayout>
         <div className='flex flex-col flex-grow items-center justify-center bg-white rounded-xl min-h-[500px]'>
            <div className='flex items-center justify-center bg-[#3ba5f0] rounded-t-xl min-h-[45px] w-full'></div>
            <div className='flex flex-col items-center justify-around min-h-[380px] w-full'>
               ...
               <p className='text-center px-5'>
                  Procure o e-mail com o título <strong>Verify your email for mentobible</strong>{' '}
                  para confirmar seu cadastro.
               </p>
               <Link href='/' className='bg-[#2b0567] text-white px-7 py-2 rounded-lg mb-2'>
                  Acessar
               </Link>
            </div>
